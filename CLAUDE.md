...
- **Language:** Java (upgrading from 8 → 11; see active branch notes below)
- **Build:** Gradle 6.9
...
- **Microservices:** ~24 independently containerized services in `platform/arcus-containers/`
- **Event-driven:** Kafka-based async messaging between services
- **Code generation:** Protocol bindings, capability/service definitions, and Groovy driver DSL are generated at build time
- **Device Abstraction:** HAL (Hardware Abstraction Layer) for hub hardware differences
- **Plugin/DI:** Services use Guice modules loaded via Governator
